...
int main() {
    ...
    inputFile = fopen("outputSerial.bin", "rb"); // Nombre del archivo binario generado por el compresor
    outputFile = fopen("decompressed.txt", "w"); // Nombre del archivo de texto descomprimido
